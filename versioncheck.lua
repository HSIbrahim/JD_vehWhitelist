...
updatePath = "/JokeDevil/JD_vehWhitelist" -- your git user/repo path
resourceName = "JD_vehWhitelist ("..GetCurrentResourceName()..")" -- the resource name
...
function checkVersion(err,responseText, headers)
	...
	if curVersion ~= responseText then
		...
		print( "^1\n\nYour JD_vehWhitelist version is outdated, visit the FiveM forum post to get the latest version.\nCurrent Version: "..curVersion.."Latest Version: "..responseText.." \n^0" )
	end
end
